...
// Utils
import { documentTypeSelectData } from '../../utils';
...
function ClientGeneralTabComponent(props: Props) {
  const { documentTypeId, document, name, lastName, alias } = componentFields;
  const { submitFunction, defaultValues, docTypes } = props;
        ...
        {({ handleSubmit }) => (
          <ScrollView
            ...
            <View>
              ...
              <Input containerStyle={GeneralStyles.marginT15} input={alias} />
...
export default ClientGeneralTabComponent;
