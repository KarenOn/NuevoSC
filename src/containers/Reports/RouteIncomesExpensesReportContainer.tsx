...
const RouteIncomesExpensesReportContainer: React.FC = () => {
  ...
  const [mutate, { status, error }] = useRouteIncomesExpenses();
  ...
  return (
    <RouteDayBalanceReportComponent
      ...
      link={link}
      reportTitle="Reporte ingresos/egresos"
      onRouteChange={onRouteChange}
    />
  );
};

export default RouteIncomesExpensesReportContainer;
